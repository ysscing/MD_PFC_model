function [ time_series, time_series1 ] = dynamic_pv( T, rp, g_EE, sp)
    sq_time = -1 : T.dt : T.T;
    [g, p, f, r, s, I] = paramete( g_EE, rp.D1, T.trial);

    time_series = zeros( 0.1/T.dt, T.trial );
    time_series1 = zeros( 0.5/T.dt, T.trial );
    count = 1; count1 = 1;
...
% * Evolution gate variable according to fire rate
        ...
        % * stimulation was applied at the corresponding time
