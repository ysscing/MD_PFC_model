function [dy] = solve_Jacobian(t, y_jac, rE1_fixed, param)
    g = param.g;
    p = param.p;
    f = param.f;
    I = param.I;
...
%          sDend1; sDend2; sAdapt1; sAdapt2; sAdapt3; sAdapt4; sAdapt5; sAdapt6; sAdapt7];
    ...
    rE2 = y_jac(1);   % rE1 is now the only element of r.E in y_fix
    ...
    dy = [ drE(2); drI; dsNMDA; dsAMPA; dsGABA; dsDend; dsAdapt];
